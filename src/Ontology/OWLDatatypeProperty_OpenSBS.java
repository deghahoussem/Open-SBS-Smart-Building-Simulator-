...
public class OWLDatatypeProperty_OpenSBS implements OWLDatatypeProperty {

	private String NameDatatypeProperty;
	private OWLNamedClass_OpenSBS SuperDatatypeProperty;
	private List<OWLNamedClass_OpenSBS> SubDatatypeProperty;

	public String getNameDatatypeProperty() {
		return NameDatatypeProperty;
	}

	public void setNameDatatypeProperty(String nameDatatypeProperty) {
		NameDatatypeProperty = nameDatatypeProperty;
	}

	public OWLNamedClass_OpenSBS getSuperDatatypeProperty() {
		return SuperDatatypeProperty;
	}

	public void setSuperDatatypeProperty(OWLNamedClass_OpenSBS superDatatypeProperty) {
		SuperDatatypeProperty = superDatatypeProperty;
	}

	public List<OWLNamedClass_OpenSBS> getSubDatatypeProperty() {
		return SubDatatypeProperty;
	}

	public void setSubDatatypeProperty(List<OWLNamedClass_OpenSBS> subDatatypeProperty) {
		SubDatatypeProperty = subDatatypeProperty;
	}

	public OWLDatatypeProperty_OpenSBS(String name) {
		this.NameDatatypeProperty = name;
